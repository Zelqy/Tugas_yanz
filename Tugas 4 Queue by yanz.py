...
if __name__ == "__main__":
    ...
    while True:
        ...
        print("3. Lihat jumlah dokumen pada antrian")
        print("4. Keluar")
        pilihan = input("Masukkan pilihan Anda (1-4): ")

        if pilihan == "1":
            dokumen = input("Masukkan nama dokumen yang akan ditambahkan: ")
            ...
            print(f"Jumlah dokumen pada antrian: {printer_queue.size()}")
        elif pilihan == "4":
